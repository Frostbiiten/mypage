...
function Project({name, imgSrc, tags, link, desc})
{
    ...
    return (
        <div class="flex flex-col items-center lg:items-start lg:flex-row gap-2">
            <motion.div
            animate={inView ? 'visible' : 'hidden'}
            variants={variants}
            transition={{ duration: 2, ease: cubicBezier(.16, 1, .3, 1) }}
            ref={ref}
            class="rounded-lg border-[3px] border-emerald-950 h-96 w-[90%] lg:w-[40rem] shadow-lg overflow-clip font-SpaceGrotesk ">
            ...
            class="text-white text-left rounded-lg backdrop-blur-sm p-5 -z-10 w-[20rem] lg:w-[23rem] leading-8">
                ...
                <div class= "mt-3 text-xs lg:text-base">{desc}</div>
            </motion.div>
        </div>
    );
}
...
function Projects() {
    ...
    return (
        <>
            <div class="lg:sticky top-0 h-[18rem] p-8 z-20">
                <h1 class="text-6xl lg:text-8xl text-white font-SpaceGrotesk">Projects</h1>
            </div>
...
function Overview() {
    ...
    const img1Offset = useTransform(scrollY, value => value * -0.3);
    const img2Offset = useTransform(scrollY, value => value * -0.6);

    return (
        <div class="flex flex-row justify-center w-full">
            <div class="rounded-xl m-4 overflow-clip h-fit lg:h-[24rem] max-w-[60rem] min-w-[90vw] flex flex-row">
                <div class="min-w-[60%] max-w-full lg:max-w-[40rem] bg-slate-50 shrink-0 p-10 text-left flex flex-col gap-5">
                    <div class="flex flex-row items-center gap-5 font-Mono">
                        <h1 class="text-4xl lg:text-8xl text-zinc-900 font-bold"> Hello! </h1>
                        <h2 class="text-xl lg:text-3xl text-zinc-900"> I'm<br /> Edem! </h2>
                    </div>
                    <p class="text-sm lg:text-xl">I'm a Canadian student interested in computer science and mathematics. In my free time, you can find me developing or playing games, working on art, or solving challenging puzzles. Check out my contacts below if you would like to reach me!</p>
                    <div class="flex flex-row flex-wrap gap-1">
                        <a href="https://github.com/Frostbiiten" target="_blank" type="button" class="text-white bg-slate-900 hover:bg-blue-600 focus:ring-2 focus:ring-[#24292F]/50 font-medium rounded-lg lg:text-sm text-xs px-[0.85rem] lg:px-5 py-2.5 text-center inline-flex items-center mr-2 mb-2 ease-out-expo duration-300 hover:scale-105">
                        ...
                        <a href="https://www.linkedin.com/in/edem-hoggar-b00153217/" target="_blank" type="button" class="text-white bg-slate-900 hover:bg-blue-600 focus:ring-2 focus:ring-[#24292F]/50 font-medium rounded-lg text-xs lg:text-sm px-[0.85rem] lg:px-5 py-2.5 text-center inline-flex items-center mr-2 mb-2 ease-out-expo duration-300 hover:scale-105">
                        ...
                        <a href="mailto: edemkhoggar@gmail.com" target="_blank" type="button" class="text-white bg-slate-900 hover:bg-blue-600 focus:ring-2 focus:ring-[#24292F]/50 font-medium rounded-lg text-xs lg:text-sm px-[0.85rem] lg:px-5 py-2.5 text-center inline-flex items-center mr-2 mb-2 ease-out-expo duration-300 hover:scale-105">
                        ...
                        <button
                            type="button"
                            class="text-white bg-slate-900 hover:bg-blue-600 focus:ring-2 focus:ring-[#24292F]/50 font-medium rounded-lg text-xs lg:text-sm px-[0.85rem] lg:px-5 py-2.5 text-center inline-flex items-center mr-2 mb-2 ease-out-expo duration-300 hover:scale-105"
                ...
                <div class="min-w-[30rem] h-20 grid">
